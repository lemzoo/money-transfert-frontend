...
# This file is nothing but a half comented example. Why ?
# Well karma considers running 0 tests is an error...
...
describe 'Service: session', ->
  ...
  beforeEach module 'xin.session'
  beforeEach module 'xin.sessionTools'
